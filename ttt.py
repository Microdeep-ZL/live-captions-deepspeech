...
# one channel, resampled
wave_file = wave.open("oneChannel_resampled.wav", 'wb')
wave_file.setnchannels(1)
wave_file.setsampwidth(pyaudio.get_sample_size(pyaudio.paInt16))
wave_file.setframerate(16000)

# raw
wave_file1 = wave.open("raw.wav", 'wb')
wave_file1.setnchannels(2)
wave_file1.setsampwidth(pyaudio.get_sample_size(pyaudio.paInt16))
wave_file1.setframerate(48000)

# one channel
wave_file2 = wave.open("oneChannel.wav", 'wb')
wave_file2.setnchannels(1)
wave_file2.setsampwidth(pyaudio.get_sample_size(pyaudio.paInt16))
wave_file2.setframerate(48000)
...
class VADAudio:
    ...
    def __init__(self):
        def callback(in_data, frame_count, time_info, status):
            ...
            wave_file1.writeframes(in_data)
    ...
    def read_resampled(self):
        ...
        data16=data16[::self.channels] # select only the first channel
        wave_file2.writeframes(data16.tobytes())
